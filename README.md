...
File Descriptions:
  PerfectTrails.png- EER Diagram
  Retrieval Queries- SQL queries to extract data for different usecases
  Schema- Database schema  
  Visualization.rmd- R markdown file to derive insights from database
